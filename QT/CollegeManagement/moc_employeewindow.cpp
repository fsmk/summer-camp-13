...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_EmployeeWindow_t, stringdata) + ofs \
...
const QMetaObject EmployeeWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_EmployeeWindow.data,
      qt_meta_data_EmployeeWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EmployeeWindow.stringdata))
