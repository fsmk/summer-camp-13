...
#include "../CollegeManagement/studentwindow.h"
...
static const char qt_meta_stringdata_StudentWindow[] = {
    "StudentWindow\0"
};
...
const QMetaObjectExtraData StudentWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StudentWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StudentWindow,
      qt_meta_data_StudentWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StudentWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StudentWindow))
